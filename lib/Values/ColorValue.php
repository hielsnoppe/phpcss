...
class ColorValue implements Value {
    ...
    // Illegal in PHP 5.5.9, available in PHP 5.6
    //const KEYWORD_HEX_VALUE = array(
    private static $KEYWORD_HEX_VALUE = array(
    ...
    public function __construct ($value) {
        ...
        */
        ...
        $patterns = array(
            ...
            'rgba' => '/^rgba\(\s*(?P<red>[0-9]{1,3})\s*,\s*(?P<green>[0-9]{1,3})\s*,\s*(?P<blue>[0-9]{1,3})\s*,\s*(?P<alpha>[0-1]?\.?[0-9]{1,2})\s*\)$/',
            /*
